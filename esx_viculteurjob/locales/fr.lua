...
Locales['fr'] = {
	...
	['vigneron_client'] = 'client vicultier',
	['transforming_in_progress'] = 'Transformation de la pomme en cours',
	['raisin_taken'] = 'Vous être en train de ramasser de la pomme',
	['press_traitement'] = 'appuyez sur ~INPUT_CONTEXT~ pour transformer votre pomme',
	['press_collect'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter de la pomme',
	['press_sell'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre vos produits',
	['no_jus_sale'] = 'Vous n\'avez plus ou pas assez de jus de pomme',
	['no_vin_sale'] = 'Vous n\'avez plus ou pas assez de Champagne',
	['not_enough_raisin'] = 'Vous n\'avez plus de pomme',
	['grand_cru'] = '~g~Génial, un grand jus !~w~',
	['no_product_sale'] = 'Vous n\'avez plus de produits',
	['press_traitement_jus'] = 'appuyez sur ~INPUT_CONTEXT~ pour transformer votre pomme',
	['used_jus'] = 'Vous avez bu du jus de pomme',
	['used_grand_cru'] = 'Vous avez bu une bouteille de grand jus',
